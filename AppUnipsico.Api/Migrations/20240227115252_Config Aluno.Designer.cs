...
namespace AppUnipsico.Api.Migrations
{
    ...
    [Migration("20240227115252_Config Aluno")]
    partial class ConfigAluno
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppUnipsico.Api.Models.TipoUsuarioModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TipoUsuarioId = 1,
                            TipoUsuarioDataRegistro = new DateTime(2024, 2, 27, 8, 52, 52, 62, DateTimeKind.Local).AddTicks(8520),
                        ...
                        {
                            TipoUsuarioId = 2,
                            TipoUsuarioDataRegistro = new DateTime(2024, 2, 27, 8, 52, 52, 62, DateTimeKind.Local).AddTicks(8542),
                        ...
                        {
                            TipoUsuarioId = 3,
                            TipoUsuarioDataRegistro = new DateTime(2024, 2, 27, 8, 52, 52, 62, DateTimeKind.Local).AddTicks(8545),
            ...
            modelBuilder.Entity("AppUnipsico.Api.Modelos.AlunoModel", b =>
                {
            ...
            modelBuilder.Entity("AppUnipsico.Api.Models.EstagioModel", b =>
                {
                    b.HasOne("AppUnipsico.Api.Modelos.AlunoModel", "Aluno")
                        .WithMany("Estagios")
